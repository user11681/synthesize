...
/**
 * This annotation type marks a method as a setter for a field with the name specified by {@link Setter#value} <br>
...
public @interface Setter {
    ...
    /**
     * @return the chaining type for the target setter, which determines whether {@code this} will be loaded<br>
     * just before returning or not in order to allow method chaining like that commonly used by builders.
     *
     * @see ChainType
     */
    ChainType chainType() default ChainType.AUTOMATIC;
