...
/**
 * This annotation marks a method as an adder for a field with the name specified by {@link #value}<br>
 * and of the same type as the return type of the said method.
 * <br><br>
 * The target's body is not deleted; rather, the field is incremented<br>
...
public @interface Adder {
    ...
    /**
     * @return the name of the field to increment. If it does not exist,<br>
